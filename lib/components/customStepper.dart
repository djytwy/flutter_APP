...
class _StepperState extends State<CustomStepper> with TickerProviderStateMixin {
  ...
  Widget _buildLine(bool visible, bool first, int index) {
    // 魔改进度线部分
    return Container(
      width: visible ? 140.0 : 0.0,
      height: 15,
        ...
        children: <Widget>[
          Positioned(
            ...
            child: Container(
              ...
              child: Text(
                first || first == null ? '' : 
                widget.steps[index].status == null || widget.steps[index].status == "" ? "0分" :
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              _buildLine(!_isFirst(index), true, index),
              _buildIcon(index),
              _buildLine(!_isLast(index), false, index),
            ],
          ),
          Container(
