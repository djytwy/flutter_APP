                        ...
                        child: GestureDetector(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Text('即时工单', style: TextStyle(color: white_color, fontSize: _adapt.setFontSize(14)))
                            ],
                          ),
                        )
                      ),
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: (){
                            k = '系统工单';
                            Navigator.push(context, MaterialPageRoute(
                              builder: (context) => InTimeWorkOrder(taskType:"3")
                            ));
                          },
                          child: Column(
                            children: <Widget>[
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage('assets/images/系统工单.png'),
                                    fit: BoxFit.cover
                                  ),
                                  borderRadius: BorderRadius.all(Radius.circular(5))
                                )
                              ),
                              Text('系统工单', style: TextStyle(color: white_color, fontSize: _adapt.setFontSize(14)))
                            ],
                          ),
                        )
                      )
