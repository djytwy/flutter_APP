...
import '../../services/pageHttpInterface/myReportFix.dart';
import 'package:fluttertoast/fluttertoast.dart';

class MyReportFix extends StatefulWidget {
  MyReportFix({Key key, this.orderID}) : super(key: key);
  final orderID;

  _MyReportFixState createState() => _MyReportFixState();
}

class _MyReportFixState extends State<MyReportFix> {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent, 
          title: Center(
            child: Text('新工单',style: TextStyle(fontSize: ScreenUtil.getInstance().setSp(36)))
          ),
          actions: <Widget>[
            Container(
