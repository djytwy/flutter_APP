...
class InApproval extends StatefulWidget {
  InApproval({Key key, this.type}) : super(key: key);
  final String type;
  _InApprovalState createState() => _InApprovalState();
}

class _InApprovalState extends State<InApproval> {
  String userName = ''; //用户名
  int userId; //用户id
  ...
  void getUnreadList(){
    var params = {
        ...
        'msgType': 1,
        'msgIsread': 0,
        'msgStatus': 202 // 200-我的处理;201-待审批;202-审批中;203-管理员已审批；204-普通员工已同意]
    };
    // 获取未读列表
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Text('审批中', style: TextStyle(fontSize: 18),),
            centerTitle: true,
            backgroundColor: Colors.transparent,
          ),
          body: Column(
