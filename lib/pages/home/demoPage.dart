    ...
    return Column(
      children: <Widget>[
        ...
        RaisedButton(
          ...
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => WorkOrderList(workOrderType: "1", userID: "24",)
            ));
          },
        ),
        RaisedButton(
          ...
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => WorkOrderList(workOrderType: "2", userID: "24",)
            ));
          },
        ),
        RaisedButton(
          ...
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => WorkOrderList(workOrderType: "3", userID: "24",)
            ));
          },
        ),
        RaisedButton(
